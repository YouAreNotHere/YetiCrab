...
const AttractionItem = ({ attraction, setAttractions, attractions, isAdminMode }: Props) => {
    ...
    return (
        <div className="attraction-item">
            ...
            <div className={isAdminMode ? "attraction-item__action-buttons" : "attraction-item__action-buttons--hidden"}>
                <Button view="flat" size="s" onClick={() => setIsModalOpen(true)}>
                    <Pen/>
                </Button>
                <Button view="flat" size="s" onClick={deleteItem}>
                    <Cross/>
                </Button>
            </div>
